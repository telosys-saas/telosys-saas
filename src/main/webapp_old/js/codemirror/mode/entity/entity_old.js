  ...
  CodeMirror.defineMode("entity", function() {
    ...
    function normal() {
      return function(source, setState) {
        ...
        if (source.eat('@')) {
          // annotation
          return switchState(source, setState, annotation);
        }
    ...
    function annotation(source, setState) {
      setState("meta");
      while (!(source.eol() || source.eat(whiteCharRE) || source.eat(specialRE))) {
        source.next();
      }
      setState(normal());
      return "annotation";
